                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-success btn-views" data-toggle="tooltip"
                                               title="Views" href="<c:url value="/new?id=${item.newId}"/> "> <i
    ...
    function deleteComment(data) {
        $.ajax({
            ...
            success: function (result) {
                window.location.href = "${CommentURL}?offset=1&limit=8&sortName=id&asc=true&message=delete_success";
            },
            error: function (error) {
                window.location.href = "${CommentURL}?offset=1&limit=8&sortName=id&asc=true&message=error_system";
            }
        });
    }
</script>
